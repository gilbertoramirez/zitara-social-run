              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="background-color:#faf5ed;border-radius:12px;margin:24px 0;">
                ...
                <tr>
                  <td style="padding:0 24px 24px;">
                    ...
                    <p style="margin:0;color:#313323;font-size:16px;"><strong>6:20 AM</strong> — Registro y calentamiento</p>
                    <p style="margin:4px 0 0;color:#313323;font-size:16px;"><strong>7:00 AM</strong> — Inicio de la carrera</p>
                  </td>
                </tr>
              </table>
